...
import com.github.evaggelos99.ems.ticket.api.converters.TicketDtoToTicketConverter;
import com.github.evaggelos99.ems.ticket.api.repo.ITicketRepository;
import com.github.evaggelos99.ems.ticket.api.repo.TicketRowMapper;
...
public class TicketRepository implements ITicketRepository {
	...
	private Mono<Ticket> saveTicket(final TicketDto ticket) {
		...
		return rowsAffected.filter(this::rowsAffectedAreMoreThanOne).map(n_ -> ticketDtoToTicketConverter
