...
import io.github.evaggelos99.ems.common.api.service.ILookUpService;
...
public class EventLookUpRemoteService implements IRemoteServiceClient {
    ...
    public EventLookUpRemoteService(final WebClient.Builder webClientBuilder,
                                     @Value("${io.github.evaggelos99.ems.event.simulator.event-service-url}") final String ticketUrl) {
