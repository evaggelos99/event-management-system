...
public class DatabaseConfiguration {
    ...
    public DatabaseConfiguration(@Value("${io.github.evaggelos99.ems.attendee-service.db.username}") final String username,
                                 @Value("${io.github.evaggelos99.ems.attendee-service.db.password}") final String password,
