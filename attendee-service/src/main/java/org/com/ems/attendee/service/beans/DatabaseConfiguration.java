...
public class DatabaseConfiguration {
	...
	ConnectionFactory postgresqlConnectionFactory() {
		...
		return new PostgresqlConnectionFactory(
				PostgresqlConnectionConfiguration.builder().host(this.host).port(Integer.parseInt(this.port))
						.database(this.database).username(this.username).password(this.password).connectTimeout(TIMEOUT)
