...
//	@JsonSerialize(using = DurationSerialzer.class)
	...
	public Event(final UUID uuid, final Instant lastUpdated, @NotNull final String name, @NotNull final String place,
			@NotNull final EventType eventType, @NotNull final Collection<UUID> attendeesIDs,
			@NotNull final UUID organizerID, @NotNull final Integer limitOfPeople, final UUID sponsorID,
	...
	public int hashCode() {
		...
		return new HashCodeBuilder(17, 37).appendSuper(super.hashCode()).append(this.name).append(this.place)
				...
				.append(this.sponsorID).append(this.startTimeOfEvent).append(this.durationOfEvent).toHashCode();
	}
