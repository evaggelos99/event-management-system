 ...
 */
public record OrganizerDto(@Schema(hidden = true) UUID uuid, @Schema(hidden = true) Instant updatedTimestamp,
		...
		@Schema(description = "The event types that organizer has specializes in") Collection<EventType> eventTypes,
